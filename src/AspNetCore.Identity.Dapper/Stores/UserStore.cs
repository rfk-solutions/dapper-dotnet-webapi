...
namespace AspNetCore.Identity.Dapper.Stores
{
    ...
    {
        private readonly UsersProvider _usersTable;
        private readonly UserRolesProvider _usersRolesTable;
        private readonly RolesProvider _rolesTable;
        private readonly UserClaimsProvider _usersClaimsTable;
        private readonly UserLoginsProvider _usersLoginsTable;
        private readonly UserTokensProvider _userTokensTable;
