    ...
    internal class UsersProvider
    {
        ...
        public async Task<IdentityResult> CreateAsync(ApplicationUser user) {
            var command = $"INSERT INTO [{_databaseConnectionFactory.DbSchema}].[AspNetUsers] " +
                                   "VALUES (@Id, @FirstName, @LastName, @UserName, @NormalizedUserName, @Email, @NormalizedEmail, @EmailConfirmed, @PasswordHash, @SecurityStamp, @ConcurrencyStamp, " +
                                           "@PhoneNumber, @PhoneNumberConfirmed, @TwoFactorEnabled, @LockoutEnd, @LockoutEnabled, @AccessFailedCount, @UserType, @IsActive, @RefreshToken, @RefreshTokenExpiryTime);";
        ...
        public async Task<IdentityResult> UpdateAsync(ApplicationUser user) {
            ...
            // write to the database. This makes sense because this way we avoid connection to the database all the time and also we can commit all changes at once by using a transaction.
             var updateUserCommand =
                ...
                "SET UserName = @UserName, FirstName = @FirstName, LastName = @LastName, NormalizedUserName = @NormalizedUserName, Email = @Email, NormalizedEmail = @NormalizedEmail, EmailConfirmed = @EmailConfirmed, " +
                    ...
                    "AccessFailedCount = @AccessFailedCount, UserType = @UserType, IsActive = @IsActive, RefreshToken = @RefreshToken, RefreshTokenExpiryTime = @RefreshTokenExpiryTime " +
                "WHERE Id = @Id;";
